	...
	public class TQGGameController:MonoBehaviour 
	{
		...
		IEnumerator GameOver(float delay)
		{
			...
			if ( gameOverCanvas )    
			{
				...
				if ( gameOverCanvas.Find("ScoreTexts/TextScore") )    gameOverCanvas.Find("ScoreTexts/TextScore").GetComponent<Text>().text = "POIN KAMU " + players[currentPlayer].score.ToString();
				...
				gameOverCanvas.Find("ScoreTexts/TextHighScore").GetComponent<Text>().text = "POIN TERTINGGI " + highScore.ToString();
		...
		IEnumerator Victory(float delay)
		{
			...
			if ( victoryCanvas )    
			{
				...
				{
					//Write the score text, if it exists
					victoryCanvas.Find("ScoreTexts/TextScore").GetComponent<Text>().text = "POIN KAMU " + players[currentPlayer].score.ToString();
					...
					//Write the high sscore text
					victoryCanvas.Find("ScoreTexts/TextHighScore").GetComponent<Text>().text = "POIN TERTINGGI " + highScore.ToString();
				}
